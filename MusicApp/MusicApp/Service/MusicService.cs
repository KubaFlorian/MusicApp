...
namespace MusicApp.Service
{
    public class MusicService
    {
        public async Task<List<Music>> GetAllSongs()
        {
            ...
            var json = await httpClient.GetStringAsync("https://crpbvswaqtpnmrgehqir.supabase.co/rest/v1/Songs?select=*");
            return JsonConvert.DeserializeObject<List<Music>>(json);
        }
    }
}
